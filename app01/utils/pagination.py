...
class Pagination(object):
    ...
    def __init__(self, request, queryset, page_size=10, page_param="page", plus=5):
        ...
        import copy
        query_dict = copy.deepcopy(request.GET)  # 得到原来的URL中的GET信息，防止分页后丢失
        query_dict._mutable = True  # 修改为可设置query_dict
            ...
            <li class="page-item" >
                <form style="float: left;" method="get">
                    <input name="page"
                           ...
                           type="text" class="form-control page-item" placeholder="输入页码">
                    <button  style="display: inline-block" class="page-link" type="submit">跳转</button>
                </form>
            </li>
            """
